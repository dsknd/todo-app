...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Interfaces\CustomProjectRoleRepository' => \App\Repositories\EloquentCustomProjectRoleRepository::class,
            'App\Repositories\Interfaces\DefaultProjectRoleRepository' => \App\Repositories\EloquentDefaultProjectRoleRepository::class,
            'App\Repositories\Interfaces\PermissionRepository' => \App\Repositories\EloquentPermissionRepository::class,
            'App\Repositories\Interfaces\ProjectMemberRepository' => \App\Repositories\EloquentProjectMemberRepository::class,
            'App\Repositories\Interfaces\ProjectRepository' => \App\Repositories\EloquentProjectRepository::class,
            'App\Repositories\Interfaces\ProjectRolePermissionRepository' => \App\Repositories\EloquentProjectRolePermissionRepository::class,
            'App\Repositories\Interfaces\ProjectRoleRepository' => \App\Repositories\EloquentProjectRoleRepository::class,
            'App\UseCases\CheckProjectRolePermissionUseCase' => \App\UseCases\Implementations\CheckProjectRolePermission::class,
            'App\UseCases\CreateProjectUseCase' => \App\Interactors\CreateProjectInteractor::class,
            'App\UseCases\DeleteProjectUseCase' => \App\Interactors\DeleteProjectInteractor::class,
            'App\UseCases\FetchOwnedProjectsUseCase' => \App\Interactors\FetchOwnedProjectsInteractor::class,
            'App\UseCases\FetchParticipatingProjectsUseCase' => \App\Interactors\FetchParticipatingProjectsInteractor::class,
            'App\UseCases\FindProjectUseCase' => \App\Interactors\FindProjectInteractor::class,
            'App\UseCases\UpdateProjectUseCase' => \App\Interactors\UpdateProjectInteractor::class,
    ...
    override(\config(), map([
            ...
            'scribe.routes.0.match.versions' => 'array',
            ...
            'scribe_new.example_languages' => 'array',
            ...
            'scribe_new.examples.models_source' => 'array',
            'scribe_new.routeMatcher' => 'NULL',
            'scribe_new.database_connections_to_transact' => 'array',
            ...
            'scribe_new.strategies.metadata' => 'array',
            'scribe_new.strategies.urlParameters' => 'array',
            'scribe_new.strategies.queryParameters' => 'array',
            'scribe_new.strategies.headers' => 'array',
            'scribe_new.strategies.headers.3' => 'array',
            'scribe_new.strategies.headers.3.1.Content-Type' => 'string',
            'scribe_new.strategies.headers.3.1.Accept' => 'string',
            'scribe_new.strategies.bodyParameters' => 'array',
            'scribe_new.strategies.responses' => 'array',
            'scribe_new.strategies.responses.5' => 'array',
            'scribe_new.strategies.responses.5.1.only' => 'array',
            ...
            'scribe_new.strategies.responseFields' => 'array',
            'scribe_new.routes.0.match.prefixes' => 'array',
            'scribe_new.routes.0.match.domains' => 'array',
            'scribe_new.routes.0.match.versions' => 'array',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','scribe.title','scribe.description',
'scribe.base_url','scribe.routes.0.match.prefixes','scribe.routes.0.match.domains','scribe.routes.0.match.versions','scribe.routes.0.include',
'scribe.routes.0.exclude','scribe.type','scribe.theme','scribe.static.output_path','scribe.laravel.add_routes',
'scribe.laravel.docs_url','scribe.laravel.assets_directory','scribe.laravel.middleware','scribe.external.html_attributes','scribe.try_it_out.enabled',
'scribe.try_it_out.base_url','scribe.try_it_out.use_csrf','scribe.try_it_out.csrf_url','scribe.auth.enabled','scribe.auth.default',
'scribe.auth.in','scribe.auth.name','scribe.auth.use_value','scribe.auth.placeholder','scribe.auth.extra_info',
'scribe.intro_text','scribe.example_languages','scribe.postman.enabled','scribe.postman.overrides','scribe.openapi.enabled',
'scribe.openapi.overrides','scribe.groups.default','scribe.groups.order','scribe.logo','scribe.last_updated',
'scribe.examples.faker_seed','scribe.examples.models_source','scribe.strategies.metadata','scribe.strategies.urlParameters','scribe.strategies.queryParameters',
'scribe.strategies.headers','scribe.strategies.headers.2','scribe.strategies.headers.2.1.Content-Type','scribe.strategies.headers.2.1.Accept','scribe.strategies.bodyParameters',
'scribe.strategies.responses','scribe.strategies.responses.5','scribe.strategies.responses.5.1.only','scribe.strategies.responses.5.1.config.app.debug','scribe.strategies.responseFields',
'scribe.database_connections_to_transact','scribe.fractal.serializer','scribe.routeMatcher','scribe_new.__configVersion','scribe_new.theme',
'scribe_new.title','scribe_new.description','scribe_new.base_url','scribe_new.type','scribe_new.static.output_path',
'scribe_new.try_it_out.enabled','scribe_new.try_it_out.base_url','scribe_new.try_it_out.use_csrf','scribe_new.try_it_out.csrf_url','scribe_new.postman.enabled',
'scribe_new.postman.overrides','scribe_new.openapi.enabled','scribe_new.openapi.overrides','scribe_new.intro_text','scribe_new.example_languages',
'scribe_new.logo','scribe_new.last_updated','scribe_new.groups.order','scribe_new.groups.default','scribe_new.examples.faker_seed',
'scribe_new.examples.models_source','scribe_new.routeMatcher','scribe_new.database_connections_to_transact','scribe_new.fractal.serializer','scribe_new.auth.enabled',
'scribe_new.auth.default','scribe_new.auth.in','scribe_new.auth.name','scribe_new.auth.use_value','scribe_new.auth.placeholder',
'scribe_new.auth.extra_info','scribe_new.strategies.metadata','scribe_new.strategies.urlParameters','scribe_new.strategies.queryParameters','scribe_new.strategies.headers',
'scribe_new.strategies.headers.3','scribe_new.strategies.headers.3.1.Content-Type','scribe_new.strategies.headers.3.1.Accept','scribe_new.strategies.bodyParameters','scribe_new.strategies.responses',
'scribe_new.strategies.responses.5','scribe_new.strategies.responses.5.1.only','scribe_new.strategies.responses.5.1.except','scribe_new.strategies.responses.5.1.config.app.env','scribe_new.strategies.responses.5.1.queryParams',
'scribe_new.strategies.responses.5.1.bodyParams','scribe_new.strategies.responses.5.1.fileParams','scribe_new.strategies.responses.5.1.cookies','scribe_new.strategies.responseFields','scribe_new.routes.0.match.prefixes',
'scribe_new.routes.0.match.domains','scribe_new.routes.0.match.versions','scribe_new.routes.0.include','scribe_new.routes.0.exclude','ide-helper.filename',
...
'sanctum.csrf-cookie','projects.index','projects.store',
'projects.show','projects.update','projects.destroy','members.index','members.create',
'members.store','members.show','members.update','members.destroy','roles.index',
'roles.create','roles.store','roles.show','roles.update','roles.destroy',
'permissions.index','permissions.store','permissions.destroy','invitations.index','invitations.store',
'invitations.destroy','assignments.index','assignments.store','assignments.update','assignments.destroy',
'milestones.index','milestones.store','milestones.show','milestones.update','milestones.destroy',
'tasks.index','tasks.store','tasks.show','tasks.update','tasks.destroy',
'tags.index','tags.store','tags.destroy','categories.index','categories.store',
'categories.destroy','dependencies.index','dependencies.store','dependencies.update','dependencies.destroy',
'comments.index','comments.store','comments.update','comments.destroy',
'storage.local',);
