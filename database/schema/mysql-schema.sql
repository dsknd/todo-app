...
CREATE TABLE `project_role_scopes` (
  ...
  CONSTRAINT `project_role_scopes_scope_id_foreign` FOREIGN KEY (`scope_id`) REFERENCES `project_scopes` (`scope_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_scopes` (
  ...
  CONSTRAINT `project_scopes_scope_id_foreign` FOREIGN KEY (`scope_id`) REFERENCES `scopes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scope_types` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `scope_types_name_unique` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scopes` (
  ...
  KEY `scopes_parent_id_foreign` (`parent_id`),
  CONSTRAINT `scopes_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `scopes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (67,'2024_12_21_052408_create_personal_access_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (68,'2024_12_21_074432_create_project_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (69,'2024_12_21_082938_create_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (70,'2024_12_21_094040_create_tasks_table',1);
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (73,'2024_12_25_074758_create_scope_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (74,'2024_12_25_134205_create_scopes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (75,'2024_12_25_134210_create_project_scopes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (76,'2024_12_25_134359_create_project_roles_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (77,'2024_12_25_134408_create_project_role_scopes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (78,'2024_12_28_135558_create_project_role_assignments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (79,'2024_12_28_142806_create_project_invitation_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (80,'2024_12_28_142807_create_project_invitations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (81,'2024_12_28_180624_create_recurring_task_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (82,'2024_12_29_054909_create_recurring_task_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (83,'2024_12_29_055338_create_recurring_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (84,'2024_12_29_082527_create_app_logs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (85,'2024_12_30_154058_create_task_category_assigments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (86,'2024_12_30_194723_create_task_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (87,'2024_12_31_170645_create_project_task_assignments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (88,'2024_12_31_182046_create_task_relationships_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (89,'2025_01_01_063550_create_task_comment_relationships_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (90,'2025_01_01_174126_create_project_task_statistics_table',1);
