...
CREATE TABLE `project_permissions` (
  ...
  KEY `project_permissions_project_id_foreign` (`project_id`),
  ...
  CONSTRAINT `project_permissions_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_role_assignments` (
  ...
  KEY `project_role_assignments_role_id_foreign` (`role_id`),
  ...
  CONSTRAINT `project_role_assignments_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `project_roles` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `projects` (
  ...
  CONSTRAINT `projects_status_id_foreign` FOREIGN KEY (`status_id`) REFERENCES `project_statuses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task_categories` (
  ...
  KEY `task_categories_project_id_foreign` (`project_id`),
  CONSTRAINT `task_categories_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `task_categories_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (29,'0001_01_01_000000_create_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'0001_01_01_000001_create_cache_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'0001_01_01_000002_create_jobs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2024_12_21_000000_create_task_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2024_12_21_000001_create_task_priorities_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2024_12_21_000003_create_task_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2024_12_21_052408_create_personal_access_tokens_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2024_12_21_074432_create_project_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2024_12_21_082938_create_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2024_12_21_094040_create_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2024_12_21_145520_create_task_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2024_12_22_160429_create_project_members_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2024_12_25_134205_create_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2024_12_25_134210_create_project_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2024_12_25_134359_create_project_roles_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2024_12_28_142806_create_project_invitation_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2024_12_28_142807_create_project_invitations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2024_12_28_180624_create_recurring_task_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2024_12_29_054909_create_recurring_task_statuses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2024_12_29_055338_create_recurring_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2024_12_29_082527_create_app_logs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2024_12_30_154058_create_task_category_assigments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (51,'2024_12_30_194723_create_task_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (52,'2024_12_31_170645_create_project_task_assignments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (53,'2024_12_31_182046_create_task_relationships_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (54,'2025_01_01_063550_create_task_comment_relationships_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (55,'2025_01_01_174126_create_project_task_statistics_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (56,'2025_01_02_122201_create_project_role_assignments_table',1);
